...
namespace ConnectedCommunity.Services
{
    ...
    public class CommunityVerifier:ICommunityVerifier
    {
        ...
        public async Task<ValidationResult> VerifyCommunity(int communityId)
        {
            ...
            if (Community == null)
            {
                return new ValidationResult(MessageStrings.Get(MessageStrings.CommunityDoesNotExist));
            }
        ...
        public async Task<ValidationResult> VerifyActiveCommunity(int communityId)
        {
            ...
            if (!Community.Active)
            {
                return new ValidationResult(MessageStrings.Get(MessageStrings.CommunityInactive));
            }
            return ValidationResult.Success;
        }
    }
